...
/// 値: カテゴリ別秒数のMap {study: 3600, pc: 1800, smartphone: 600}
 Map<String, Map<String, int>> get dailyCategorySeconds;/// 当月終了時点のレベルスナップショット
@JsonKey(toJson: _levelSnapshotToJson, fromJson: _levelSnapshotFromJson) LevelSnapshot? get levelSnapshot;/// グローバルランキング（未実装の場合null）
 int? get globalRank;/// 人検出の合計秒数
 int get personDetectedSeconds;/// 最終更新日時
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MonthlyStatistics&&(identical(other.id, id) || other.id == id)&&(identical(other.year, year) || other.year == year)&&(identical(other.month, month) || other.month == month)&&const DeepCollectionEquality().equals(other.categorySeconds, categorySeconds)&&(identical(other.totalWorkTimeSeconds, totalWorkTimeSeconds) || other.totalWorkTimeSeconds == totalWorkTimeSeconds)&&(identical(other.pieChartData, pieChartData) || other.pieChartData == pieChartData)&&const DeepCollectionEquality().equals(other.dailyCategorySeconds, dailyCategorySeconds)&&(identical(other.levelSnapshot, levelSnapshot) || other.levelSnapshot == levelSnapshot)&&(identical(other.globalRank, globalRank) || other.globalRank == globalRank)&&(identical(other.personDetectedSeconds, personDetectedSeconds) || other.personDetectedSeconds == personDetectedSeconds)&&(identical(other.lastModified, lastModified) || other.lastModified == lastModified));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,year,month,const DeepCollectionEquality().hash(categorySeconds),totalWorkTimeSeconds,pieChartData,const DeepCollectionEquality().hash(dailyCategorySeconds),levelSnapshot,globalRank,personDetectedSeconds,lastModified);

@override
String toString() {
  return 'MonthlyStatistics(id: $id, year: $year, month: $month, categorySeconds: $categorySeconds, totalWorkTimeSeconds: $totalWorkTimeSeconds, pieChartData: $pieChartData, dailyCategorySeconds: $dailyCategorySeconds, levelSnapshot: $levelSnapshot, globalRank: $globalRank, personDetectedSeconds: $personDetectedSeconds, lastModified: $lastModified)';
}
...
@useResult
$Res call({
 String id, int year, int month, Map<String, int> categorySeconds, int totalWorkTimeSeconds,@JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson) PieChartDataModel? pieChartData, Map<String, Map<String, int>> dailyCategorySeconds,@JsonKey(toJson: _levelSnapshotToJson, fromJson: _levelSnapshotFromJson) LevelSnapshot? levelSnapshot, int? globalRank, int personDetectedSeconds, DateTime lastModified
});


$PieChartDataModelCopyWith<$Res>? get pieChartData;$LevelSnapshotCopyWith<$Res>? get levelSnapshot;
...
/// Create a copy of MonthlyStatistics
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? year = null,Object? month = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? dailyCategorySeconds = null,Object? levelSnapshot = freezed,Object? globalRank = freezed,Object? personDetectedSeconds = null,Object? lastModified = null,}) {
...
as Map<String, Map<String, int>>,levelSnapshot: freezed == levelSnapshot ? _self.levelSnapshot : levelSnapshot // ignore: cast_nullable_to_non_nullable
as LevelSnapshot?,globalRank: freezed == globalRank ? _self.globalRank : globalRank // ignore: cast_nullable_to_non_nullable
as int?,personDetectedSeconds: null == personDetectedSeconds ? _self.personDetectedSeconds : personDetectedSeconds // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$LevelSnapshotCopyWith<$Res>? get levelSnapshot {
    if (_self.levelSnapshot == null) {
    return null;
  }

  return $LevelSnapshotCopyWith<$Res>(_self.levelSnapshot!, (value) {
    return _then(_self.copyWith(levelSnapshot: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int year,  int month,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  Map<String, Map<String, int>> dailyCategorySeconds, @JsonKey(toJson: _levelSnapshotToJson, fromJson: _levelSnapshotFromJson)  LevelSnapshot? levelSnapshot,  int? globalRank,  int personDetectedSeconds,  DateTime lastModified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MonthlyStatistics() when $default != null:
return $default(_that.id,_that.year,_that.month,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.dailyCategorySeconds,_that.levelSnapshot,_that.globalRank,_that.personDetectedSeconds,_that.lastModified);case _:
  return orElse();
...
/// 当月終了時点のレベルスナップショット
@override@JsonKey(toJson: _levelSnapshotToJson, fromJson: _levelSnapshotFromJson) final  LevelSnapshot? levelSnapshot;
/// グローバルランキング（未実装の場合null）
@override final  int? globalRank;
/// 人検出の合計秒数
@override@JsonKey() final  int personDetectedSeconds;
/// 最終更新日時
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,year,month,const DeepCollectionEquality().hash(_categorySeconds),totalWorkTimeSeconds,pieChartData,const DeepCollectionEquality().hash(_dailyCategorySeconds),levelSnapshot,globalRank,personDetectedSeconds,lastModified);
...
@override $PieChartDataModelCopyWith<$Res>? get pieChartData;@override $LevelSnapshotCopyWith<$Res>? get levelSnapshot;
...
/// Create a copy of MonthlyStatistics
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? year = null,Object? month = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? dailyCategorySeconds = null,Object? levelSnapshot = freezed,Object? globalRank = freezed,Object? personDetectedSeconds = null,Object? lastModified = null,}) {

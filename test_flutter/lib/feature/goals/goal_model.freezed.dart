...
mixin _$Goal {
 ...
 bool get isDeleted; DateTime get lastModified;
...
@useResult
$Res call({
 String id, String tag, String title, int targetTime, ComparisonType comparisonType, DetectionItem detectionItem, DateTime startDate, int durationDays, DateTime? periodEndDate, int targetSecondsPerDay, int consecutiveAchievements, int consecutivePeriodAchievements, int? achievedTime, int? todayAchievedTime, DateTime? lastResetDate, DateTime? lastAchievedEventShownAt, bool isDeleted, DateTime lastModified
});
...
/// Create a copy of Goal
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? tag = null,Object? title = null,Object? targetTime = null,Object? comparisonType = null,Object? detectionItem = null,Object? startDate = null,Object? durationDays = null,Object? periodEndDate = freezed,Object? targetSecondsPerDay = null,Object? consecutiveAchievements = null,Object? consecutivePeriodAchievements = null,Object? achievedTime = freezed,Object? todayAchievedTime = freezed,Object? lastResetDate = freezed,Object? lastAchievedEventShownAt = freezed,Object? isDeleted = null,Object? lastModified = null,}) {
...
as int,periodEndDate: freezed == periodEndDate ? _self.periodEndDate : periodEndDate // ignore: cast_nullable_to_non_nullable
as DateTime?,targetSecondsPerDay: null == targetSecondsPerDay ? _self.targetSecondsPerDay : targetSecondsPerDay // ignore: cast_nullable_to_non_nullable
...
as int,consecutivePeriodAchievements: null == consecutivePeriodAchievements ? _self.consecutivePeriodAchievements : consecutivePeriodAchievements // ignore: cast_nullable_to_non_nullable
as int,achievedTime: freezed == achievedTime ? _self.achievedTime : achievedTime // ignore: cast_nullable_to_non_nullable
as int?,todayAchievedTime: freezed == todayAchievedTime ? _self.todayAchievedTime : todayAchievedTime // ignore: cast_nullable_to_non_nullable
as int?,lastResetDate: freezed == lastResetDate ? _self.lastResetDate : lastResetDate // ignore: cast_nullable_to_non_nullable
as DateTime?,lastAchievedEventShownAt: freezed == lastAchievedEventShownAt ? _self.lastAchievedEventShownAt : lastAchievedEventShownAt // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Goal() when $default != null:
return $default(_that.id,_that.tag,_that.title,_that.targetTime,_that.comparisonType,_that.detectionItem,_that.startDate,_that.durationDays,_that.periodEndDate,_that.targetSecondsPerDay,_that.consecutiveAchievements,_that.consecutivePeriodAchievements,_that.achievedTime,_that.todayAchievedTime,_that.lastResetDate,_that.lastAchievedEventShownAt,_that.isDeleted,_that.lastModified);case _:
  return orElse();
...
class _Goal implements Goal {
  const _Goal({required this.id, required this.tag, required this.title, required this.targetTime, required this.comparisonType, required this.detectionItem, required this.startDate, required this.durationDays, this.periodEndDate, this.targetSecondsPerDay = 0, this.consecutiveAchievements = 0, this.consecutivePeriodAchievements = 0, this.achievedTime, this.todayAchievedTime, this.lastResetDate, this.lastAchievedEventShownAt, this.isDeleted = false, required this.lastModified});
...
@override final  int? todayAchievedTime;
// その日の達成時間（秒単位、1日ごとにリセット）
@override final  DateTime? lastResetDate;
// 最後にリセットされた日付
@override final  DateTime? lastAchievedEventShownAt;
// 最後に目標達成イベントが表示された日時
...
/// Create a copy of Goal
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? tag = null,Object? title = null,Object? targetTime = null,Object? comparisonType = null,Object? detectionItem = null,Object? startDate = null,Object? durationDays = null,Object? periodEndDate = freezed,Object? targetSecondsPerDay = null,Object? consecutiveAchievements = null,Object? consecutivePeriodAchievements = null,Object? achievedTime = freezed,Object? todayAchievedTime = freezed,Object? lastResetDate = freezed,Object? lastAchievedEventShownAt = freezed,Object? isDeleted = null,Object? lastModified = null,}) {
  return _then(_Goal(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,tag: null == tag ? _self.tag : tag // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable

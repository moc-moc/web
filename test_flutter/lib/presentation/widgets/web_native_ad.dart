...
class WebNativeAd extends StatefulWidget {
  ...
  @override
  State<WebNativeAd> createState() => _WebNativeAdState();
}

class _WebNativeAdState extends State<WebNativeAd> {
  ...
  void initState() {
    super.initState();
    _viewType = 'web-native-ad-${DateTime.now().millisecondsSinceEpoch}';
  ...
  void _registerViewFactory() {
    ...
    try {
      ui_web.platformViewRegistry.registerViewFactory(_viewType, (int viewId) {
        final widthStyle = widget.width != null 
            ? 'width:${widget.width}px;' 
            : 'width:100%;';
        
        final html.Element element = html.Element.html('''
          <ins class="adsbygoogle"
               style="display:block; $widthStyle height:${widget.height}px;"

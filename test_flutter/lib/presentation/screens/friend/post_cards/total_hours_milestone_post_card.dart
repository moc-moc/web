...
/// 合計作業時間大台更新投稿カード
class TotalHoursMilestonePostCard extends StatefulWidget {
  ...
  const TotalHoursMilestonePostCard({
    super.key,
  ...
  @override
  State<TotalHoursMilestonePostCard> createState() => _TotalHoursMilestonePostCardState();
}

class _TotalHoursMilestonePostCardState extends State<TotalHoursMilestonePostCard> {
  bool _isCommentsExpanded = false;

  // ダミーコメントデータ
  final List<Map<String, String>> _dummyComments = [
    {'author': 'Alice', 'text': 'Amazing achievement! Keep it up!'},
    {'author': 'Bob', 'text': 'You are an inspiration!'},
    {'author': 'Charlie', 'text': 'Congratulations on this milestone!'},
  ];

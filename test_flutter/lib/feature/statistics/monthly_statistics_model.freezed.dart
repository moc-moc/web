...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,year,month,const DeepCollectionEquality().hash(categorySeconds),totalWorkTimeSeconds,pieChartData,lastModified);

@override
String toString() {
  return 'MonthlyStatistics(id: $id, year: $year, month: $month, categorySeconds: $categorySeconds, totalWorkTimeSeconds: $totalWorkTimeSeconds, pieChartData: $pieChartData, lastModified: $lastModified)';
}
...
@useResult
$Res call({
 String id, int year, int month, Map<String, int> categorySeconds, int totalWorkTimeSeconds,@JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson) PieChartDataModel? pieChartData, DateTime lastModified
});
...
/// Create a copy of MonthlyStatistics
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? year = null,Object? month = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? lastModified = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int year,  int month,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  DateTime lastModified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MonthlyStatistics() when $default != null:
return $default(_that.id,_that.year,_that.month,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.lastModified);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int year,  int month,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  DateTime lastModified)  $default,) {final _that = this;
switch (_that) {
case _MonthlyStatistics():
return $default(_that.id,_that.year,_that.month,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.lastModified);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int year,  int month,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  DateTime lastModified)?  $default,) {final _that = this;
switch (_that) {
case _MonthlyStatistics() when $default != null:
return $default(_that.id,_that.year,_that.month,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.lastModified);case _:
  return null;
...
class _MonthlyStatistics extends MonthlyStatistics {
  const _MonthlyStatistics({required this.id, required this.year, required this.month, required final  Map<String, int> categorySeconds, required this.totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson) this.pieChartData, required this.lastModified}): _categorySeconds = categorySeconds,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,year,month,const DeepCollectionEquality().hash(_categorySeconds),totalWorkTimeSeconds,pieChartData,lastModified);
...
/// Create a copy of MonthlyStatistics
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? year = null,Object? month = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? lastModified = null,}) {

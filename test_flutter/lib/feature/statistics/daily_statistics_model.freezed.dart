...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,date,const DeepCollectionEquality().hash(categorySeconds),totalWorkTimeSeconds,pieChartData,lastModified);

@override
String toString() {
  return 'DailyStatistics(id: $id, date: $date, categorySeconds: $categorySeconds, totalWorkTimeSeconds: $totalWorkTimeSeconds, pieChartData: $pieChartData, lastModified: $lastModified)';
}
...
@useResult
$Res call({
 String id, DateTime date, Map<String, int> categorySeconds, int totalWorkTimeSeconds,@JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson) PieChartDataModel? pieChartData, DateTime lastModified
});
...
/// Create a copy of DailyStatistics
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? date = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? lastModified = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime date,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  DateTime lastModified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DailyStatistics() when $default != null:
return $default(_that.id,_that.date,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.lastModified);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime date,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  DateTime lastModified)  $default,) {final _that = this;
switch (_that) {
case _DailyStatistics():
return $default(_that.id,_that.date,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.lastModified);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime date,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  DateTime lastModified)?  $default,) {final _that = this;
switch (_that) {
case _DailyStatistics() when $default != null:
return $default(_that.id,_that.date,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.lastModified);case _:
  return null;
...
class _DailyStatistics extends DailyStatistics {
  const _DailyStatistics({required this.id, required this.date, required final  Map<String, int> categorySeconds, required this.totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson) this.pieChartData, required this.lastModified}): _categorySeconds = categorySeconds,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,date,const DeepCollectionEquality().hash(_categorySeconds),totalWorkTimeSeconds,pieChartData,lastModified);
...
/// Create a copy of DailyStatistics
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? date = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? lastModified = null,}) {

...
/// 固定ID（'tracking_settings'）
 ...
 String? get selectedSmartphoneGoalId;/// スマホ使用時間アラートの有効/無効
 bool get smartphoneAlertEnabled;/// スマホ使用時間アラートの時間（分）
 int get smartphoneAlertMinutes;/// スマホ使用時間アラートの時間（秒）
 int get smartphoneAlertSeconds;/// 最終更新日時
 DateTime get lastModified;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrackingSettings&&(identical(other.id, id) || other.id == id)&&(identical(other.isCameraOn, isCameraOn) || other.isCameraOn == isCameraOn)&&(identical(other.isPowerSavingMode, isPowerSavingMode) || other.isPowerSavingMode == isPowerSavingMode)&&(identical(other.selectedStudyGoalId, selectedStudyGoalId) || other.selectedStudyGoalId == selectedStudyGoalId)&&(identical(other.selectedPcGoalId, selectedPcGoalId) || other.selectedPcGoalId == selectedPcGoalId)&&(identical(other.selectedSmartphoneGoalId, selectedSmartphoneGoalId) || other.selectedSmartphoneGoalId == selectedSmartphoneGoalId)&&(identical(other.smartphoneAlertEnabled, smartphoneAlertEnabled) || other.smartphoneAlertEnabled == smartphoneAlertEnabled)&&(identical(other.smartphoneAlertMinutes, smartphoneAlertMinutes) || other.smartphoneAlertMinutes == smartphoneAlertMinutes)&&(identical(other.smartphoneAlertSeconds, smartphoneAlertSeconds) || other.smartphoneAlertSeconds == smartphoneAlertSeconds)&&(identical(other.lastModified, lastModified) || other.lastModified == lastModified));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,isCameraOn,isPowerSavingMode,selectedStudyGoalId,selectedPcGoalId,selectedSmartphoneGoalId,smartphoneAlertEnabled,smartphoneAlertMinutes,smartphoneAlertSeconds,lastModified);

@override
String toString() {
  return 'TrackingSettings(id: $id, isCameraOn: $isCameraOn, isPowerSavingMode: $isPowerSavingMode, selectedStudyGoalId: $selectedStudyGoalId, selectedPcGoalId: $selectedPcGoalId, selectedSmartphoneGoalId: $selectedSmartphoneGoalId, smartphoneAlertEnabled: $smartphoneAlertEnabled, smartphoneAlertMinutes: $smartphoneAlertMinutes, smartphoneAlertSeconds: $smartphoneAlertSeconds, lastModified: $lastModified)';
}
...
@useResult
$Res call({
 String id, bool isCameraOn, bool isPowerSavingMode, String? selectedStudyGoalId, String? selectedPcGoalId, String? selectedSmartphoneGoalId, bool smartphoneAlertEnabled, int smartphoneAlertMinutes, int smartphoneAlertSeconds, DateTime lastModified
});
...
/// Create a copy of TrackingSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? isCameraOn = null,Object? isPowerSavingMode = null,Object? selectedStudyGoalId = freezed,Object? selectedPcGoalId = freezed,Object? selectedSmartphoneGoalId = freezed,Object? smartphoneAlertEnabled = null,Object? smartphoneAlertMinutes = null,Object? smartphoneAlertSeconds = null,Object? lastModified = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as String?,smartphoneAlertEnabled: null == smartphoneAlertEnabled ? _self.smartphoneAlertEnabled : smartphoneAlertEnabled // ignore: cast_nullable_to_non_nullable
as bool,smartphoneAlertMinutes: null == smartphoneAlertMinutes ? _self.smartphoneAlertMinutes : smartphoneAlertMinutes // ignore: cast_nullable_to_non_nullable
as int,smartphoneAlertSeconds: null == smartphoneAlertSeconds ? _self.smartphoneAlertSeconds : smartphoneAlertSeconds // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  bool isCameraOn,  bool isPowerSavingMode,  String? selectedStudyGoalId,  String? selectedPcGoalId,  String? selectedSmartphoneGoalId,  bool smartphoneAlertEnabled,  int smartphoneAlertMinutes,  int smartphoneAlertSeconds,  DateTime lastModified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrackingSettings() when $default != null:
return $default(_that.id,_that.isCameraOn,_that.isPowerSavingMode,_that.selectedStudyGoalId,_that.selectedPcGoalId,_that.selectedSmartphoneGoalId,_that.smartphoneAlertEnabled,_that.smartphoneAlertMinutes,_that.smartphoneAlertSeconds,_that.lastModified);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  bool isCameraOn,  bool isPowerSavingMode,  String? selectedStudyGoalId,  String? selectedPcGoalId,  String? selectedSmartphoneGoalId,  bool smartphoneAlertEnabled,  int smartphoneAlertMinutes,  int smartphoneAlertSeconds,  DateTime lastModified)  $default,) {final _that = this;
switch (_that) {
case _TrackingSettings():
return $default(_that.id,_that.isCameraOn,_that.isPowerSavingMode,_that.selectedStudyGoalId,_that.selectedPcGoalId,_that.selectedSmartphoneGoalId,_that.smartphoneAlertEnabled,_that.smartphoneAlertMinutes,_that.smartphoneAlertSeconds,_that.lastModified);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  bool isCameraOn,  bool isPowerSavingMode,  String? selectedStudyGoalId,  String? selectedPcGoalId,  String? selectedSmartphoneGoalId,  bool smartphoneAlertEnabled,  int smartphoneAlertMinutes,  int smartphoneAlertSeconds,  DateTime lastModified)?  $default,) {final _that = this;
switch (_that) {
case _TrackingSettings() when $default != null:
return $default(_that.id,_that.isCameraOn,_that.isPowerSavingMode,_that.selectedStudyGoalId,_that.selectedPcGoalId,_that.selectedSmartphoneGoalId,_that.smartphoneAlertEnabled,_that.smartphoneAlertMinutes,_that.smartphoneAlertSeconds,_that.lastModified);case _:
  return null;
...
class _TrackingSettings extends TrackingSettings {
  const _TrackingSettings({required this.id, required this.isCameraOn, required this.isPowerSavingMode, this.selectedStudyGoalId, this.selectedPcGoalId, this.selectedSmartphoneGoalId, required this.smartphoneAlertEnabled, required this.smartphoneAlertMinutes, required this.smartphoneAlertSeconds, required this.lastModified}): super._();
...
/// スマホ使用時間アラートの有効/無効
@override final  bool smartphoneAlertEnabled;
/// スマホ使用時間アラートの時間（分）
@override final  int smartphoneAlertMinutes;
/// スマホ使用時間アラートの時間（秒）
@override final  int smartphoneAlertSeconds;
/// 最終更新日時
@override final  DateTime lastModified;
...
/// Create a copy of TrackingSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? isCameraOn = null,Object? isPowerSavingMode = null,Object? selectedStudyGoalId = freezed,Object? selectedPcGoalId = freezed,Object? selectedSmartphoneGoalId = freezed,Object? smartphoneAlertEnabled = null,Object? smartphoneAlertMinutes = null,Object? smartphoneAlertSeconds = null,Object? lastModified = null,}) {

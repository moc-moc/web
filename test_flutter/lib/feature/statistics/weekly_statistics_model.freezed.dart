...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,weekStart,const DeepCollectionEquality().hash(categorySeconds),totalWorkTimeSeconds,pieChartData,lastModified);

@override
String toString() {
  return 'WeeklyStatistics(id: $id, weekStart: $weekStart, categorySeconds: $categorySeconds, totalWorkTimeSeconds: $totalWorkTimeSeconds, pieChartData: $pieChartData, lastModified: $lastModified)';
}
...
@useResult
$Res call({
 String id, DateTime weekStart, Map<String, int> categorySeconds, int totalWorkTimeSeconds,@JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson) PieChartDataModel? pieChartData, DateTime lastModified
});
...
/// Create a copy of WeeklyStatistics
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? weekStart = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? lastModified = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime weekStart,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  DateTime lastModified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WeeklyStatistics() when $default != null:
return $default(_that.id,_that.weekStart,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.lastModified);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime weekStart,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  DateTime lastModified)  $default,) {final _that = this;
switch (_that) {
case _WeeklyStatistics():
return $default(_that.id,_that.weekStart,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.lastModified);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime weekStart,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  DateTime lastModified)?  $default,) {final _that = this;
switch (_that) {
case _WeeklyStatistics() when $default != null:
return $default(_that.id,_that.weekStart,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.lastModified);case _:
  return null;
...
class _WeeklyStatistics extends WeeklyStatistics {
  const _WeeklyStatistics({required this.id, required this.weekStart, required final  Map<String, int> categorySeconds, required this.totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson) this.pieChartData, required this.lastModified}): _categorySeconds = categorySeconds,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,weekStart,const DeepCollectionEquality().hash(_categorySeconds),totalWorkTimeSeconds,pieChartData,lastModified);
...
/// Create a copy of WeeklyStatistics
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? weekStart = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? lastModified = null,}) {

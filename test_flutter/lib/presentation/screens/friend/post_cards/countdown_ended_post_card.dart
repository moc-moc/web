...
/// カウントダウン終了投稿カード
class CountdownEndedPostCard extends StatefulWidget {
  ...
  @override
  State<CountdownEndedPostCard> createState() => _CountdownEndedPostCardState();
}

class _CountdownEndedPostCardState extends State<CountdownEndedPostCard> {
  bool _isCommentsExpanded = false;

  // ダミーコメントデータ
  final List<Map<String, String>> _dummyComments = [
    {'author': 'Alice', 'text': 'Congratulations! Good luck!'},
    {'author': 'Bob', 'text': 'You made it!'},
  ];

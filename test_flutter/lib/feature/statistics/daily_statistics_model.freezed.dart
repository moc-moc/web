...
/// 値: カテゴリ別秒数のMap {study: 600, pc: 300, ...}
 Map<String, Map<String, int>> get hourlyCategorySeconds;/// トラッキング回数（その日のトラッキング実行回数）
 int get trackingCount;/// 最終更新日時
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DailyStatistics&&(identical(other.id, id) || other.id == id)&&(identical(other.date, date) || other.date == date)&&const DeepCollectionEquality().equals(other.categorySeconds, categorySeconds)&&(identical(other.totalWorkTimeSeconds, totalWorkTimeSeconds) || other.totalWorkTimeSeconds == totalWorkTimeSeconds)&&(identical(other.pieChartData, pieChartData) || other.pieChartData == pieChartData)&&const DeepCollectionEquality().equals(other.hourlyCategorySeconds, hourlyCategorySeconds)&&(identical(other.trackingCount, trackingCount) || other.trackingCount == trackingCount)&&(identical(other.lastModified, lastModified) || other.lastModified == lastModified));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,date,const DeepCollectionEquality().hash(categorySeconds),totalWorkTimeSeconds,pieChartData,const DeepCollectionEquality().hash(hourlyCategorySeconds),trackingCount,lastModified);

@override
String toString() {
  return 'DailyStatistics(id: $id, date: $date, categorySeconds: $categorySeconds, totalWorkTimeSeconds: $totalWorkTimeSeconds, pieChartData: $pieChartData, hourlyCategorySeconds: $hourlyCategorySeconds, trackingCount: $trackingCount, lastModified: $lastModified)';
}
...
@useResult
$Res call({
 String id, DateTime date, Map<String, int> categorySeconds, int totalWorkTimeSeconds,@JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson) PieChartDataModel? pieChartData, Map<String, Map<String, int>> hourlyCategorySeconds, int trackingCount, DateTime lastModified
});
...
/// Create a copy of DailyStatistics
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? date = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? hourlyCategorySeconds = null,Object? trackingCount = null,Object? lastModified = null,}) {
  return _then(_self.copyWith(
...
as Map<String, Map<String, int>>,trackingCount: null == trackingCount ? _self.trackingCount : trackingCount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime date,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  Map<String, Map<String, int>> hourlyCategorySeconds,  int trackingCount,  DateTime lastModified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DailyStatistics() when $default != null:
return $default(_that.id,_that.date,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.hourlyCategorySeconds,_that.trackingCount,_that.lastModified);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime date,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  Map<String, Map<String, int>> hourlyCategorySeconds,  int trackingCount,  DateTime lastModified)  $default,) {final _that = this;
switch (_that) {
case _DailyStatistics():
return $default(_that.id,_that.date,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.hourlyCategorySeconds,_that.trackingCount,_that.lastModified);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime date,  Map<String, int> categorySeconds,  int totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson)  PieChartDataModel? pieChartData,  Map<String, Map<String, int>> hourlyCategorySeconds,  int trackingCount,  DateTime lastModified)?  $default,) {final _that = this;
switch (_that) {
case _DailyStatistics() when $default != null:
return $default(_that.id,_that.date,_that.categorySeconds,_that.totalWorkTimeSeconds,_that.pieChartData,_that.hourlyCategorySeconds,_that.trackingCount,_that.lastModified);case _:
  return null;
...
class _DailyStatistics extends DailyStatistics {
  const _DailyStatistics({required this.id, required this.date, required final  Map<String, int> categorySeconds, required this.totalWorkTimeSeconds, @JsonKey(toJson: _pieChartDataToJson, fromJson: _pieChartDataFromJson) this.pieChartData, final  Map<String, Map<String, int>> hourlyCategorySeconds = const {}, this.trackingCount = 0, required this.lastModified}): _categorySeconds = categorySeconds,_hourlyCategorySeconds = hourlyCategorySeconds,super._();
...
@override@JsonKey() final  int trackingCount;
/// 最終更新日時
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,date,const DeepCollectionEquality().hash(_categorySeconds),totalWorkTimeSeconds,pieChartData,const DeepCollectionEquality().hash(_hourlyCategorySeconds),trackingCount,lastModified);
...
/// Create a copy of DailyStatistics
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? date = null,Object? categorySeconds = null,Object? totalWorkTimeSeconds = null,Object? pieChartData = freezed,Object? hourlyCategorySeconds = null,Object? trackingCount = null,Object? lastModified = null,}) {

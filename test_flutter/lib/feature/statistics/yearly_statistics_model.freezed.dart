...
/// @nodoc
mixin _$YearlyStatistics {

/// 識別子（年ベース、例: "2024"）
 String get id;/// 年
 int get year;/// カテゴリ別の時間（秒単位）
...
$YearlyStatisticsCopyWith<YearlyStatistics> get copyWith => _$YearlyStatisticsCopyWithImpl<YearlyStatistics>(this as YearlyStatistics, _$identity);

  /// Serializes this YearlyStatistics to a JSON map.
...
/// @nodoc
abstract mixin class $YearlyStatisticsCopyWith<$Res>  {
...
/// @nodoc
class _$YearlyStatisticsCopyWithImpl<$Res>
    implements $YearlyStatisticsCopyWith<$Res> {
  _$YearlyStatisticsCopyWithImpl(this._self, this._then);

  final YearlyStatistics _self;
  final $Res Function(YearlyStatistics) _then;
...
/// Adds pattern-matching-related methods to [YearlyStatistics].
extension YearlyStatisticsPatterns on YearlyStatistics {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _YearlyStatistics value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _YearlyStatistics value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _YearlyStatistics value)?  $default,){
final _that = this;
switch (_that) {
case _YearlyStatistics() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$YearlyStatisticsCopyWith<_YearlyStatistics> get copyWith => __$YearlyStatisticsCopyWithImpl<_YearlyStatistics>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$YearlyStatisticsToJson(this, );
}
...
/// @nodoc
abstract mixin class _$YearlyStatisticsCopyWith<$Res> implements $YearlyStatisticsCopyWith<$Res> {
...
/// @nodoc
class __$YearlyStatisticsCopyWithImpl<$Res>
    implements _$YearlyStatisticsCopyWith<$Res> {
  __$YearlyStatisticsCopyWithImpl(this._self, this._then);

  final _YearlyStatistics _self;
  final $Res Function(_YearlyStatistics) _then;
